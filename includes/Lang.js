...
Lang.translations   = {
    en: {
        ...
        screenSettingsName: 'Settings',
        screenAboutName: 'About',
        ...
        settingsSubtitle: 'Adjust how the app looks and find project information.',
        settingsThemeSectionTitle: 'Theme',
        settingsThemeSectionDescription: 'Choose the appearance that feels best for your device.',
        settingsAboutRowTitle: 'About BelgranoWear',
        settingsAboutRowDescription: 'Credits, source code, and open-source acknowledgements.',
        appVersionLabel: 'Version %s',
        aboutAppTitle: 'About BelgranoWear',
        aboutDescription: 'BelgranoWear helps passengers check Belgrano Norte departures, favorite frequent routes, and keep useful schedule information available when connectivity is unreliable.',
        aboutCreatorLabel: 'Created by %s.',
        aboutRepositoryLabel: 'Open source repository',
        aboutOpenRepositoryLabel: 'Open the BelgranoWear source code repository',
        aboutAcknowledgementsTitle: 'Open-source acknowledgements',
        aboutAcknowledgementsDescription: 'This app is built with the following direct open-source dependencies. Tap any library to learn more about the project behind it.',
        aboutLibraryLinkHint: 'Open the %s project website or repository',
        aboutLibraryCategoryExpo: 'Expo platform',
        aboutLibraryCategoryReactNative: 'React Native foundation',
        aboutLibraryCategoryNavigation: 'Navigation and device interaction',
        aboutLibraryCategoryInterface: 'Interface and icons',
        aboutLibraryCategoryUtilities: 'Data and utilities',
        retryBtnLabel: 'Retry',
    ...
    es: {
        ...
        screenSettingsName: 'Ajustes',
        screenAboutName: 'Acerca de',
        ...
        settingsSubtitle: 'Configurá cómo se ve la app y consultá información del proyecto.',
        settingsThemeSectionTitle: 'Tema',
        settingsThemeSectionDescription: 'Elegí la apariencia que mejor se adapte a tu dispositivo.',
        settingsAboutRowTitle: 'Acerca de BelgranoWear',
        settingsAboutRowDescription: 'Créditos, código fuente y reconocimientos de código abierto.',
        appVersionLabel: 'Versión %s',
        aboutAppTitle: 'Acerca de BelgranoWear',
        aboutDescription: 'BelgranoWear ayuda a consultar salidas del Belgrano Norte, guardar recorridos frecuentes y mantener información útil de horarios disponible cuando la conectividad es inestable.',
        aboutCreatorLabel: 'Creado por %s.',
        aboutRepositoryLabel: 'Repositorio de código fuente',
        aboutOpenRepositoryLabel: 'Abrir el repositorio de código fuente de BelgranoWear',
        aboutAcknowledgementsTitle: 'Reconocimientos de código abierto',
        aboutAcknowledgementsDescription: 'Esta app está construida con las siguientes dependencias directas de código abierto. Tocá cualquier biblioteca para conocer más sobre el proyecto detrás de ella.',
        aboutLibraryLinkHint: 'Abrir el sitio web o repositorio de %s',
        aboutLibraryCategoryExpo: 'Plataforma Expo',
        aboutLibraryCategoryReactNative: 'Base React Native',
        aboutLibraryCategoryNavigation: 'Navegación e interacción con el dispositivo',
        aboutLibraryCategoryInterface: 'Interfaz e íconos',
        aboutLibraryCategoryUtilities: 'Datos y utilidades',
